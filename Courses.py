...
Backend_course = [['Python', 'https://www.udemy.com/course/100-days-of-code/'],
                  ['Java', 'https://education.oracle.com/java/java/pFamily_48/'],
                  ['PHP', 'https://www.smart-academy.in/course/php-certification-course/'],
                  ['SQl', 'https://www.udemy.com/course/learnsql/'],
                  ['Git', 'https://www.edureka.co/git-certification-training-course/'],
                  ['HTML,CSS,Javascript','https://in.coursera.org/learn/html-css-javascript-for-web-developers'],
                  ['nodeJs', 'https://openjsf.org/certification/'],
                  ['expressJs','https://openjsf.org/certification/'],
                  ['Django', 'https://www.coursera.org/specializations/django'],
                  ['postgreSQL','https://www.udemy.com/topic/postgresql/'],
                  ['mangoDB','https://learn.mongodb.com/pages/certification-program'],
                  ['DSA', 'https://www.upgrad.com/blog/data-structures-algorithm-free-online-course/']]

frontend_course = [['HTML,CSS,Javascript','https://in.coursera.org/learn/html-css-javascript-for-web-developers'],
                  ['HTML','https://www.w3schools.com/html/'],
                  ['Jquery','https://www.codecademy.com/learn/learn-jquery'],
                  ['Typescript',' https://www.udemy.com/course/typescript/'],
                  ['AJAX', 'https://www.mygreatlearning.com/ajax/free-courses'],
                  ['JSON', 'https://in.coursera.org/courses?query=json'],
                  ['bootsrap', 'https://in.coursera.org/courses?query=bootstrap'],
                  ['angular', 'https://www.simplilearn.com/angular-certification-training-course'],
                  ['reactjs', 'https://reactjs.org/community/courses.html'],
                  ['nodeJs', 'https://openjsf.org/certification/']]

fullstack_course = [['Python', 'https://www.udemy.com/course/100-days-of-code/'],
                  ['Java', 'https://education.oracle.com/java/java/pFamily_48/'],
                  ['PHP', 'https://www.smart-academy.in/course/php-certification-course/'],
                  ['SQl', 'https://www.udemy.com/course/learnsql/'],
                  ['Git', 'https://www.edureka.co/git-certification-training-course/'],
...
testing_course = [['HTML,CSS,Javascript','https://in.coursera.org/learn/html-css-javascript-for-web-developers'],
                  ['HTML','https://www.w3schools.com/html/'],
                  ['Jquery','https://www.codecademy.com/learn/learn-jquery'],
                  ['Typescript',' https://www.udemy.com/course/typescript/'],
                  ['SOAPUI API', 'https://www.udemy.com/course/soapui-from-scratch-step-by-step/'],
                  ['REST API', 'https://www.fita.in/rest-api-testing-training/'],
                  ['SQl', 'https://www.udemy.com/course/learnsql/'],
                  ['Automation testing course', 'https://www.simplilearn.com/automation-testing-masters-program-certification-training-course']]

analyst_course = [['R language', 'https://alison.com/courses/introduction-to-r-programming/'],
                  ['Python', 'https://www.udemy.com/course/100-days-of-code/'],
                  ['SQl', 'https://www.udemy.com/course/learnsql/'],
                  ['Machine Learning', 'https://www.mygreatlearning.com/academy/learn-for-free/courses/'],
                  ['Matlab', 'https://www.classcentral.com/report/matlab-free-certificates/']]

network_course = [['Ruby','https://www.udemy.com/course/the-complete-ruby-on-rails-developer-course/'],
                  ['Perl', 'https://alison.com/course/introduction-to-perl-programming'],
                  ['Python', 'https://www.udemy.com/course/100-days-of-code/'],
                  ['IOT', 'https://alison.com/course/fundamentals-of-internet-of-things'],
                  ['MPLS', 'https://www.udemy.com/course/mpls-fundamentals-for-cisco-ccnp-real-world/']]
